...
import 'teen/homecontent.dart'; // Assuming this is your home screen content widget
import 'teen/profilecontent.dart'; // ProfileContent widget
import 'teen/analyticscontent.dart'; // AnalyticsContent widget
import 'login.dart'; // Login screen

class TeenDashboard extends StatefulWidget {
  final String username;

  const TeenDashboard({Key? key, required this.username}) : super(key: key);

  @override
  _TeenDashboardState createState() => _TeenDashboardState();
}
