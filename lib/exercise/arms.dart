...
import 'another_dashboard.dart'; // Import the updated AnotherDashboard
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: _buildExerciseBox("Jumping Jack", "3 Sets of 10 Reps", "assets/img/jumpingjack.webp"),
            ),
...
class RunningDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExerciseDashboard(
      ...
      videoPath: 'assets/video/Running.mp4',
      steps: [
...
class JumpingJackDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExerciseDashboard(
      title: "Jumping Jacks",
      description: "Jumping Jacks are a full-body workout that engages your arms.",
      videoPath: 'assets/video/Jumping_Jacks.mp4',
      steps: [
