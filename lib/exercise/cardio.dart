...
class PushUpDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExerciseDashboard(
      ...
      videoPath: 'assets/video/Push-Up.mp4', // Update to correct video path
      steps: [
        Step(
...
class SquatDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExerciseDashboard(
      ...
      videoPath: 'assets/video/crunches.mp4', // Update to correct video path
      steps: [
        Step(
...
class LungesDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExerciseDashboard(
      ...
      videoPath: 'assets/video/Lunges.mp4', // Update to correct video path
      steps: [
        Step(
          title: "Step 1: Start Position",
