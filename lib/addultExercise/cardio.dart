          ...
          children: [
            ...
            const SizedBox(height: 16),
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const DumbleDashboard()),
                );
              },
              child: _buildExerciseBox("Dumble", "45 Minutes", "assets/img/dumbel.jpg"),
            ),
            const SizedBox(height: 16),
            ...
            GestureDetector(
              ...
              child: _buildExerciseBox("Planks", "15 Minutes", "assets/img/planks.jpg"),
            ),
          ],
        ),
      ),
...
class DumbleDashboard extends StatelessWidget {
  const DumbleDashboard({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ExerciseDashboard(
      title: "Dumble Exercise",
      description: "Lunges are great for improving balance and leg strength.",
      videoPath: 'assets/video/crunch.mp4', // Update to correct video path
      steps: [
        Step(
