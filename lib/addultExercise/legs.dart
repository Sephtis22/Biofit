...
class LegsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Core Exercise"),
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: _buildExerciseBox("Set up", "3 Sets of 15 Reps", "assets/img/setup.jpg"),
            ),
            ...
            GestureDetector(
              ...
              child: _buildExerciseBox("Leg Raises", "3 Sets of 15 Reps", "assets/img/legraises.jpg"),
            ),
