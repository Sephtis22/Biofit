...
class YogaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Flexibility and mobility"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildExerciseBox(context, "Stretching", "Hold for 30 seconds", "assets/img/stretching.jpg", const CrunchesDashboard()),
              const SizedBox(height: 16),
              _buildExerciseBox(context, "Yoga", "Hold for 30 seconds", "assets/img/yoga.jpg", const RussianTwistsDashboard()),
              const SizedBox(height: 16),
              _buildExerciseBox(context, "Pilates", "Hold for 30 seconds", "assets/img/pilates.jpg", const LegRaisesDashboard()),
              const SizedBox(height: 16),
